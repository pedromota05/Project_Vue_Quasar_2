<template>
  <q-header elevated>
	...
	<q-input rounded outlined dense debounce="300" v-model="filter" placeholder="Search" color="#fff" class="q-mr-sm col-8" style="padding-right: 16px; justify-content: end" v-if="isMobile">
